package com.snipthink.bsearchapi;
    ...
    private static class SearchAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                String bingUrl = "https://api.cognitive.microsoft.com" + searchStr + "%27" + numOfResultsStr + "&$format=json";
                String accountKey = "c910303d7aa14108844592d3c3f6c09f";
